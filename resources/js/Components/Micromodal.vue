...
<template>
  ...
  <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" @click="searchCustomers" type="button" data-micromodal-trigger="modal-1">
    検索する
  </button>
</template>
